...
const basePath = '.'
const globalName = 'LeaferX.connector' // <script /> 插件的全局变量名
const supportPlatforms = ['web','worker','node','miniapp']
const external = {'@leafer-ui/core':  'LeaferUI','@leafer-in/arrow':  'LeaferIN.arrow'} // 声明外部依赖，不打进插件包，只引用
...
if(isDev) {
    ...
    config = {
        ...
        plugins: [
            ...plugins,
             html({
                title: "Leafer Plugin - QnConnector",
